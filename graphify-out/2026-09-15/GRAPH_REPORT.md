# Graph Report - SPX Fitness  (2026-09-15)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 91 nodes · 137 edges · 10 communities (3 shown, 7 thin omitted)
...
## Knowledge Gaps
- **12 isolated node(s):** `Constraints`, `File Map`, `js/app.js`, `js/ble.js — SPXBluetoothDriver (window.spxBleDriver)`, `js/charts.js — SpeedChart` (+7 more)
...
- **What connects `Constraints`, `File Map`, `js/app.js` to the rest of the system?**
